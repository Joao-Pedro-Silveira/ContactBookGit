...
public class Main {
    ...
    public static final String SHARED_NUM = "There are contacts that share phone numbers.";
    public static final String DIF_PHONE = "All contacts have different phone numbers.";
